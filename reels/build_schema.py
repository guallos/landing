...
featured = {"@type": "VideoObject",
    ...
    "uploadDate": "2026-07-04", "duration": "PT9M41S",
...
shorts = [
    yt("YBZ-CSoLCss", "Tu Caso Legal", "Asesoría jurídica con inteligencia artificial para colombianos.", "2025-12-03", "PT35S"),
    yt("Ls6kI-jiDcA", "Si trabajas en casa, la ley cambió", "Cambios legales para el trabajo en casa en Colombia.", "2025-11-03", "PT28S"),
    yt("51Po7NEGzfA", "¿Vivieron juntos más de dos años?", "Unión marital de hecho: derechos tras dos años de convivencia.", "2025-11-04", "PT28S"),
    yt("wiyEbWDBcFM", "Prescripción de deudas en Colombia", "Cuándo prescriben las deudas en Colombia.", "2025-11-11", "PT28S"),
    yt("X-LUOHPSYKo", "Nueva ley de divorcio", "Qué cambia con la nueva ley de divorcio en Colombia.", "2025-11-05", "PT28S"),
    yt("njoVgALV9pw", "Eliminar reportes negativos", "Cómo eliminar reportes negativos en las centrales de riesgo.", "2025-11-08", "PT28S"),
    yt("4u7OzJJ8hlg", "Embargo de salario", "Límites legales al embargo de salario en Colombia.", "2025-11-13", "PT28S"),
    yt("B-SE77MnWPo", "Devoluciones por Internet", "Derecho de retracto en compras por Internet.", "2025-11-10", "PT28S"),
    yt("w8wRLskbR7A", "Protección laboral en el embarazo", "Estabilidad laboral reforzada durante el embarazo.", "2025-11-07", "PT28S"),
    yt("NGOg_5oLbuA", "Garantía de carro usado", "Garantía legal en la compra de carro usado.", "2025-11-06", "PT28S"),
]
